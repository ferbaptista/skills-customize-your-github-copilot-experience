...
- Sempre usar Conventional Commits para mensagens de commit (por exemplo: feat:, fix:, docs:, style:, refactor:, chore:). Isso mantém o histórico claro e facilita automações/CI.
